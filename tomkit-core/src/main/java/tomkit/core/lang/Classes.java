...
public final class Classes {
    ...
    static {
        ...
        java.util.Collections.addAll(primitiveTypes, boolean[].class, byte[].class, char[].class,
     ...
     * @see Types#isAssignable(java.lang.reflect.Type, java.lang.reflect.Type)
     */
    ...
    public static String classNamesToString(Collection<Class<?>> classes) {
        if (tomkit.core.lang.Collections.isEmpty(classes)) {
            return "[]";
        }
    ...
    public static Class<?>[] toClassArray(Collection<Class<?>> collection) {
        return (!tomkit.core.lang.Collections.isEmpty(collection) ? collection.toArray(EMPTY_CLASS_ARRAY) : EMPTY_CLASS_ARRAY);
    }
